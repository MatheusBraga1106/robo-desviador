...
def point_segment_distance(points, seg_a, seg_b):
    ...
    """
    edge = seg_b - seg_a                                  # (S, 2)
    comp2 = np.einsum("sk,sk->s", edge, edge)
